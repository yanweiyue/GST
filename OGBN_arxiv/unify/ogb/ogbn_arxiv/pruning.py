...
import numpy as np
import torch
from util import get_W, get_topo_criterion
...
class GSTScheduler:
    def __init__(self, model, optimizer, remain=1, T_end=400, sparsity_distribution='uniform',
                 ...
                 accumulation_n=1, state_dict=None,pretrain=False,beta=1,warmup_steps=0,topo_k=1,sema_k=1e4,dataset="ogbn-arxiv",backbone='sage'):
